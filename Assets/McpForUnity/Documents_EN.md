...
> A clear architecture diagram is needed showing the three-layer relationship between AI client, MCP Server, and Unity
...
**[Placeholder: Editor Window Screenshot]**
> A screenshot of MCP Server Editor Window is needed, showing port configuration, start button, tool list, etc.
...
**[Placeholder: Claude Desktop Connection Screenshot]**
> A screenshot of MCP server configuration in Claude Desktop is needed
...
**[Placeholder: OpenCode Configuration Screenshot]**
> A screenshot of MCP server configuration in OpenCode is needed
