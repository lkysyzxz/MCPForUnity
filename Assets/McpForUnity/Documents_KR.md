...
**[플레이스홀더: 아키텍처 다이어그램]**
> AI 클라이언트, MCP Server, Unity의 3계층 관계를 보여주는 명확한 아키텍처 다이어그램 추가 필요
...
**[플레이스홀더: 에디터 윈도우 스크린샷]**
> MCP Server Editor Window의 스크린샷 추가 필요 (포트 설정, 시작 버튼, 도구 목록 등)
...
**[플레이스홀더: Claude Desktop 연결 스크린샷]**
> Claude Desktop에서 MCP 서버 설정 스크린샷 추가 필요
...
**[플레이스홀더: OpenCode 설정 스크린샷]**
> OpenCode에서 MCP 서버 설정 스크린샷 추가 필요
